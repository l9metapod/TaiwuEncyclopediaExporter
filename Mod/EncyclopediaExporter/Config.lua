return {
	...
	Description = "把游戏内置百科(百晓册)一键导出成 Markdown 文档，让 AI 帮你做攻略。\n\n【有什么用】\n导出 188 页百科正文 + 上万条悬浮词条详情，涵盖全部 12 章节，以及武器/盔甲/衣装/宝物/工具/药毒/引子/书籍/杂物/食物/茶酒/代步/促织等 13 种物品的完整属性卡片，外加功法/特性/出身特质/内力属性/招式。把这些资料交给 AI，它就能读懂太吾，帮你设计 Build、搭配出生效果、挑选装备、解答机制疑问、规划开局。\n\n【怎么用】\n1. 启用本 Mod，自动生成到游戏目录下的 EncyclopediaExporter_Output\\ 目录（独立于 Mod，上传工坊不会误传）\n2. 用本地 AI 工具打开该目录直接提问；或用网页 AI 上传相关章节的文件夹\n3. 不需要付费会员、不需要 API，免费额度就够用\n4. 直接问：「这两件武器哪个更适合我」「这套功法怎么搭配」「开局选什么出身」「内息紊乱怎么解」\n\n【已包含】\n· 188 页百科正文 + 100+ 张数据表格\n· 功法：正练/逆练效果、破体破气、命中分段、攻击范围、施展需要等（按游戏卡片还原）\n· 特性、出身特质、内力属性、招式\n· 武器(剑/刀/长兵/瑶琴/暗器/箫笛/对刺/掌套/短杵/拂尘/长鞭/令符/机关/针匣/药霜/毒砂/神兵/动物共18种)、盔甲、衣装、宝物、工具、药毒、引子、书籍、杂物、食物、茶酒、代步、促织——按游戏卡片版式还原属性\n【说明】\n· 物品数值按百科环境(威力满发挥100)显示，与游戏内实际物品略有出入\n· 游戏更新百科后再次启用会自动检测并重建\n· 可在设置里关闭「添加颜色标签」，生成纯文字版兼容 GitHub/论坛\n· 重建用白名单清理，你写的笔记和配置(含.md)都不会被删，可放心当工作区用\n· 本工具只读取游戏明文数据，不修改任何游戏文件",
	FrontendPlugins = {
